...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'email', 'password', 'account']  #claves que se quieren usar, adicional la cuenta, para conocer los datos de la cuenta asosciada a ese usario
    ...
    def create(self, validated_data): #validated_data: datos que ya han sido previamente validada,
        ...
        userInstance = User.objects.create_user(**validated_data) # crea el usuario con las claves seleccionadas sin la clave account y le asigna el id de ese usuario creado a la variable
